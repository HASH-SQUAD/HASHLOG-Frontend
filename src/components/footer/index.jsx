  ...
  return (
    <_.Footer_Layout>    
        <_.Footer_Container>
            ...
            <_.Footer_InfoText>개인정보책임관리자 : 강민지  | 비즈니스 문의 : ha.sh02@gmail.com |</_.Footer_InfoText>
            <_.Footer_WarningText>#ASH 사이트에 대한 모든 콘텐츠, 정보, UI,  HTML 소스 등에 대한 무단 복제, 전송, 배포, 크롤링, 스크래핑 등의 행위를 거부하며, 이러한 행위는 관련 법령에 의해 엄격히 금지됩니다.</_.Footer_WarningText>
